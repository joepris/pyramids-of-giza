...
void Dice_Model::calcAverageNormals(unsigned int* indices, unsigned int indiceCount, GLfloat* vertices, unsigned int verticeCount,
...
void Dice_Model::RenderMeshModel()
{
	glBindVertexArray(VAO);
